...
export class CommitGroupSettlementWorkflow extends WorkflowEntrypoint<
  AppBindings,
  CommitGroupSettlementWorkflowInput
> {
  async run(event: WorkflowEvent<CommitGroupSettlementWorkflowInput>, step: WorkflowStep) {
