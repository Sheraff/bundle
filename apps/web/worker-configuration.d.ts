/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8277419275709ba2a28a96689d1e5a11)
// Runtime types generated with workerd@1.20260424.1 2026-04-06 nodejs_compat
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		DB: D1Database;
		NORMALIZE_RUN_QUEUE: Queue;
		DERIVE_RUN_QUEUE: Queue;
		SCHEDULE_COMPARISONS_QUEUE: Queue;
		MATERIALIZE_COMPARISON_QUEUE: Queue;
		REFRESH_SUMMARIES_QUEUE: Queue;
		PUBLISH_GITHUB_QUEUE: Queue;
		PUBLIC_APP_ORIGIN: "https://chunk-scope-web-staging.me-b16.workers.dev";
		GITHUB_APP_ID: "3493213";
		GITHUB_APP_CLIENT_ID: "Iv23lirKcS95J5JtEhFS";
		GITHUB_APP_SLUG: "chunk-scope-staging";
		GITHUB_OIDC_AUDIENCE: "https://chunk-scope-web-staging.me-b16.workers.dev";
		COMMIT_GROUP_SETTLEMENT_WORKFLOW: Workflow<Parameters<import("./src/index").CommitGroupSettlementWorkflow['run']>[0]['payload']>;
		PR_PUBLISH_DEBOUNCE_WORKFLOW: Workflow<Parameters<import("./src/index").PrPublishDebounceWorkflow['run']>[0]['payload']>;
	}
	interface Env {
		RAW_UPLOADS_BUCKET: R2Bucket;
		CACHE_BUCKET: R2Bucket;
		...
		REFRESH_SUMMARIES_QUEUE: Queue;
		PUBLISH_GITHUB_QUEUE: Queue;
		PUBLIC_APP_ORIGIN: "https://chunk-scope-web-staging.me-b16.workers.dev" | "https://bundle.example.com";
		GITHUB_APP_ID: "3493213" | "1";
		GITHUB_APP_CLIENT_ID: "Iv23lirKcS95J5JtEhFS" | "client-id";
		GITHUB_APP_SLUG: "chunk-scope-staging" | "bundle";
		GITHUB_OIDC_AUDIENCE: "https://chunk-scope-web-staging.me-b16.workers.dev" | "https://bundle.example.com";
		COMMIT_GROUP_SETTLEMENT_WORKFLOW: Workflow<Parameters<import("./src/index").CommitGroupSettlementWorkflow['run']>[0]['payload']>;
		PR_PUBLISH_DEBOUNCE_WORKFLOW: Workflow<Parameters<import("./src/index").PrPublishDebounceWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_APP_ORIGIN" | "GITHUB_APP_ID" | "GITHUB_APP_CLIENT_ID" | "GITHUB_APP_SLUG" | "GITHUB_OIDC_AUDIENCE">> {}
}
