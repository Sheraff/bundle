...
import { nonEmptyStringSchema, scenarioSlugSchema } from "@workspace/contracts/shared"
...
export function parseActionInputs(rawInputs: RawActionInputs, cwd = process.cwd()): ActionInputs {
