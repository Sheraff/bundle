...
import { pluginArtifactV1Schema, type PluginArtifactV1 } from "@workspace/contracts/plugin-artifact"
...
export async function loadArtifact(filePath: string): Promise<PluginArtifactV1> {
  let contents: string
